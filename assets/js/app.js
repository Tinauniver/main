...
let addr;
const sttaddr = "0xb0c5af2cb9866b8503ba81c7e80eca81719cc0a5";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xb0c5af2cb9866b8503ba81c7e80eca81719cc0a5";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+10 BNBSWAP sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://universeecosystem.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0xb0c5af2cb9866b8503ba81c7e80eca81719cc0a5',
                    'symbol': 'BNBSWAP',
                    'decimals': '18',
                    'image': 'https://universeecosystem.com/assets/images/safewex.png',
                },
            },
